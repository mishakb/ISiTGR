from .baseconfig import isitgrlib, CAMBError, CAMBValueError, CAMBUnknownArgumentError, CAMB_Structure, \
...
CAMBdata_transferstopowers = isitgrlib.__camb_MOD_camb_transferstopowers
CAMBdata_transferstopowers.argtypes = [POINTER(CAMBdata)]

CAMBdata_mattertransferdata = isitgrlib.__handles_MOD_cambdata_mattertransferdata
CAMBdata_mattertransferdata.argtypes = [POINTER(CAMBdata), POINTER(_MatterTransferData)]

CAMBdata_cltransferdata = isitgrlib.__handles_MOD_cambdata_cltransferdata
CAMBdata_cltransferdata.argtypes = [POINTER(CAMBdata), POINTER(_ClTransferData), int_arg]
CAMBdata_GetLinearMatterPower = isitgrlib.__handles_MOD_cambdata_getlinearmatterpower
CAMBdata_GetLinearMatterPower.argtypes = [POINTER(CAMBdata), numpy_2d, int_arg, int_arg, int_arg]

CAMBdata_GetNonLinearMatterPower = isitgrlib.__handles_MOD_cambdata_getnonlinearmatterpower
CAMBdata_GetNonLinearMatterPower.argtypes = [POINTER(CAMBdata), numpy_2d, int_arg, int_arg, int_arg]

CAMBdata_GetMatterPower = isitgrlib.__handles_MOD_cambdata_getmatterpower
CAMBdata_GetMatterPower.argtypes = [POINTER(CAMBdata), numpy_2d,
                                    d_arg, d_arg, int_arg, int_arg, int_arg]

CAMBdata_CalcBackgroundTheory = isitgrlib.__handles_MOD_cambdata_calcbackgroundtheory
...
CAMB_SetTotCls = isitgrlib.__handles_MOD_camb_settotcls
CAMB_SetUnlensedCls = isitgrlib.__handles_MOD_camb_setunlensedcls
CAMB_SetLensPotentialCls = isitgrlib.__handles_MOD_camb_setlenspotentialcls
CAMB_SetUnlensedScalCls = isitgrlib.__handles_MOD_camb_setunlensedscalcls
CAMB_SetLensedScalCls = isitgrlib.__handles_MOD_camb_setlensedscalcls
CAMB_SetTensorCls = isitgrlib.__handles_MOD_camb_settensorcls
...
CAMB_SetUnlensedScalarArray = isitgrlib.__handles_MOD_camb_setunlensedscalararray
CAMB_SetUnlensedScalarArray.argtypes = [POINTER(CAMBdata), int_arg, ndpointer(c_double, flags='F_CONTIGUOUS', ndim=3),
                                        int_arg]

del _set_cl_args

CAMB_TimeEvolution = isitgrlib.__handles_MOD_camb_timeevolution
...
CAMB_BackgroundThermalEvolution = isitgrlib.__handles_MOD_getbackgroundthermalevolution
