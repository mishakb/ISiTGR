...
def run_command_line():
    ...
    parser.add_argument('-V', '--version', action='version', version=isitgr.__version__)
    ...
    CAMB_RunCommandLine = lib_import('isitgr', 'isitgr', 'CommandLineValidate' if args.validate else 'CommandLineRun')
