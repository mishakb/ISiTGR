from .baseconfig import isitgrlib, CAMB_Structure, F2003Class, fortran_class, numpy_1d, np, \
...
class CAMBparams(F2003Class):
    ...
    def set_cosmology(self, H0=None, ombh2=0.022, omch2=0.12, omk=0.0,
                      ...
                      bbn_predictor=None, theta_H0_range=(10, 100), parameterization=None,
                      Q0=0, Qinf=0, D0=0, R0=0, Dinf=0, Rinf=0, s=0, k_c=0, binning=None,
...
def set_default_params(P):
    ...
    isitgrlib.__camb_MOD_camb_setdefparams(byref(P))
    return P
